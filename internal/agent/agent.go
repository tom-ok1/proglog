...
import (
	...
	"github.com/tom-ok1/proglog/internal/discovery"
...
func (c Config) ListenRPCAddr() (string, error) {
...
func (c Config) AdvertiseRPCAddr() (string, error) {
...
func (a *Agent) setupServer() error {
	...
	rpcAddr, err := a.Config.ListenRPCAddr()
	if err != nil {
		return err
	}
...
func (a *Agent) setupMembership() error {
	rpcAddr, err := a.Config.ListenRPCAddr()
	rpcAdvAddr, err := a.Config.AdvertiseRPCAddr()
	if err != nil {
		return err
	}
